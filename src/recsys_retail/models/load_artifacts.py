...
RECOMMENDER_PATH = PATH + 'models/recommender_v1'
USER_FEATURES_TRANSFORMED_PATH = PATH + 'data/03_primary/user_features_transformed.csv.zip'
ITEM_FEATURES_TRANSFORMED_PATH = PATH + 'data/03_primary/item_features_transformed.csv.zip'
USER_ITEM_FEATURES_PATH = PATH + 'data/04_feature/user_item_features.csv.zip'
